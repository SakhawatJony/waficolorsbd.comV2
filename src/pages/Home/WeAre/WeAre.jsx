...
const WeAre = () => {
    ...
    return (
        <section>
            <div className="flex justify-between px-24 pt-12 items-center">
                <div className="w-1/2 space-y-5">
                    <div>
                        <img className="w-[490px] mx-auto" src={home1} alt="home image 1" />
                    </div>
                ...
                <div className="w-1/2">
                    ...
                    <div className="space-y-3 py-8 text-lg">
                        <p>Welcome to the web site of Silkflex Bangladesh Limited and thank you for your interest. This site will give you an insight into our company, its products and services, and how we work together with our business partner & the customers. Silkflex Bangladesh Limited is the exclusive distributor of Silkflex Polymer SND BHD, Malaysia.</p>
                        <p>We are operating our business from last 18 years under the name of K. M. Enterprise. Silkflex Bangladesh is the pioneer textile printing inks supplier in Bangladesh. It might be our products and services that said the way for the company’s distinctive success story. However, it’s never just about the products, but always about the people too and about the clear business ethics to the customers.</p>
                        <p>We are offering best quality with lowest price. Since we are importing directly from the manufacturer and supplying to the end user, so we can able to maintain quality with lowest price. We are assuring you that our products are the world best (better than Japan, German and another country) by excellent hand feel, high elasticity, high coverage, excellent brightness and consumption also 30% less.</p>

                    </div>
                </div>
            </div>

            {/* icon section in under  */}

            <div className="flex mx-auto px-80">
                {
                    iconSectionData.map((item) => (
                        <div key={item.id} className="w-96 text-center mx-auto space-y-3 flex flex-col justify-center items-center">
